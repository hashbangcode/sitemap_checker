...
class GuzzlePromiseCrawlerTest extends TestCase {
  ...
  public function testGuzzlePromiseCrawlerGets200Response() {
    ...
    public function testGuzzlePromiseCrawlerGets301Response() {
        $mock = new MockHandler([
    ...
    public function testGuzzlePromiseCrawlerGets404Response() {
    ...
    public function testGuzzlePromiseCrawlerGets500Response() {
    ...
    public function testGuzzlePromiseCrawlerConnectionError() {
        $mock = new MockHandler([
